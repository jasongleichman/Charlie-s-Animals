...
window.ANIMAL_DATABASE = [
  ...
  },
  {
    ...
    facts: [
      ...
      `They live in tide pools and shallow coral reefs in the Pacific and Indian oceans.`,
      `The octopus usually delivers its venomous bite when picked up or stepped on.`,
      `The venom is produced by symbiotic bacteria in their salivary glands.`,
      `They typically live for only about one to two years.`,
      `They are rarely seen by humans due to their shy nature and small size.`,
      `The Blue Ringed Octopus has three hearts.`,
...
window.sightWordsData = [
    { word: 'The word is, the', options: ['the', 'this', 'that'], correct: 'the' },
    { word: 'The word is, of', options: ['of', 'off', 'for'], correct: 'of' },
    { word: 'The word is, and', options: ['and', 'any', 'can'], correct: 'and' },
    { word: 'The word is, A', options: ['a', 'I', 'at'], correct: 'a' },
    { word: 'The word is, to', options: ['to', 'go', 'do'], correct: 'to' }, 
    { word: 'The word is, in', options: ['in', 'is', 'on'], correct: 'in' },
    { word: 'The word is, is', options: ['is', 'in', 'it'], correct: 'is' },
    { word: 'The word is, you', options: ['you', 'your', 'my'], correct: 'you' },
    { word: 'The word is, that', options: ['that', 'what', 'the'], correct: 'that' },
    { word: 'The word is, it', options: ['it', 'is', 'at'], correct: 'it' },
    { word: 'The word is, he', options: ['he', 'we', 'she'], correct: 'he' },
    { word: 'The word is, was', options: ['was', 'saw', 'has'], correct: 'was' },
    { word: 'The word is, for', options: ['for', 'from', 'get'], correct: 'for' }, 
    { word: 'The word is, on', options: ['on', 'in', 'of'], correct: 'on' },
    { word: 'The word is, are', options: ['are', 'an', 'ate'], correct: 'are' },
    { word: 'The word is, as', options: ['as', 'is', 'at'], correct: 'as' },
    { word: 'The word is, with', options: ['with', 'when', 'which'], correct: 'with' },
    { word: 'The word is, his', options: ['his', 'has', 'is'], correct: 'his' },
    { word: 'The word is, they', options: ['they', 'the', 'them'], correct: 'they' },
    { word: 'The word is, I', options: ['I', 'a', 'it'], correct: 'I' },
    { word: 'The word is, at', options: ['at', 'it', 'an'], correct: 'at' },
    { word: 'The word is, be', options: ['be', 'by', 'but'], correct: 'be' },
    { word: 'The word is, this', options: ['this', 'that', 'his'], correct: 'this' },
    { word: 'The word is, have', options: ['have', 'has', 'he'], correct: 'have' },
    { word: 'The word is, from', options: ['from', 'for', 'form'], correct: 'from' },
    { word: 'The word is, or', options: ['or', 'of', 'on'], correct: 'or' },
    { word: 'The word is, one', options: ['one', 'on', 'own'], correct: 'one' },
    { word: 'The word is, had', options: ['had', 'has', 'hide'], correct: 'had' },
    { word: 'The word is, by', options: ['by', 'be', 'my'], correct: 'by' },
    { word: 'The word is, words', options: ['words', 'work', 'was'], correct: 'words' },
    { word: 'The word is, but', options: ['but', 'put', 'bet'], correct: 'but' },
    { word: 'The word is, not', options: ['not', 'now', 'note'], correct: 'not' },
    { word: 'The word is, what', options: ['what', 'that', 'when'], correct: 'what' },
    { word: 'The word is, all', options: ['all', 'call', 'at'], correct: 'all' },
    { word: 'The word is, were', options: ['were', 'we', 'when'], correct: 'were' },
    { word: 'The word is, we', options: ['we', 'he', 'me'], correct: 'we' },
    { word: 'The word is, when', options: ['when', 'then', 'what'], correct: 'when' },
    { word: 'The word is, your', options: ['your', 'you', 'my'], correct: 'your' },
    { word: 'The word is, can', options: ['can', 'ran', 'and'], correct: 'can' },
    { word: 'The word is, said', options: ['said', 'side', 'say'], correct: 'said' },
    { word: 'The word is, there', options: ['there', 'these', 'three'], correct: 'there' },
    { word: 'The word is, use', options: ['use', 'us', 'see'], correct: 'use' },
    { word: 'The word is, an', options: ['an', 'a', 'on'], correct: 'an' },
    { word: 'The word is, each', options: ['each', 'eat', 'which'], correct: 'each' },
    { word: 'The word is, which', options: ['which', 'with', 'each'], correct: 'which' },
    { word: 'The word is, she', options: ['she', 'he', 'we'], correct: 'she' },
    { word: 'The word is, do', options: ['do', 'go', 'to'], correct: 'do' },
    { word: 'The word is, how', options: ['how', 'now', 'who'], correct: 'how' },
    { word: 'The word is, their', options: ['their', 'them', 'these'], correct: 'their' },
    { word: 'The word is, if', options: ['if', 'is', 'it'], correct: 'if' },
    { word: 'The word is, will', options: ['will', 'well', 'we'], correct: 'will' },
    { word: 'The word is, up', options: ['up', 'us', 'put'], correct: 'up' },
    { word: 'The word is, other', options: ['other', 'over', 'mother'], correct: 'other' },
    { word: 'The word is, about', options: ['about', 'but', 'out'], correct: 'about' },
    { word: 'The word is, out', options: ['out', 'put', 'odd'], correct: 'out' },
    { word: 'The word is, many', options: ['many', 'money', 'man'], correct: 'many' },
    { word: 'The word is, then', options: ['then', 'when', 'ten'], correct: 'then' },
    { word: 'The word is, them', options: ['them', 'then', 'these'], correct: 'them' },
    { word: 'The word is, these', options: ['these', 'those', 'the'], correct: 'these' },
    { word: 'The word is, so', options: ['so', 'no', 'go'], correct: 'so' },
    { word: 'The word is, some', options: ['some', 'come', 'same'], correct: 'some' },
    { word: 'The word is, her', options: ['her', 'he', 'has'], correct: 'her' },
    { word: 'The word is, would', options: ['would', 'could', 'should'], correct: 'would' },
    { word: 'The word is, make', options: ['make', 'take', 'like'], correct: 'make' },
    { word: 'The word is, like', options: ['like', 'look', 'live'], correct: 'like' },
    { word: 'The word is, him', options: ['him', 'his', 'home'], correct: 'him' },
    { word: 'The word is, into', options: ['into', 'in', 'to'], correct: 'into' },
    { word: 'The word is, time', options: ['time', 'tame', 'came'], correct: 'time' },
    { word: 'The word is, has', options: ['has', 'his', 'had'], correct: 'has' },
    { word: 'The word is, look', options: ['look', 'like', 'book'], correct: 'look' },
    { word: 'The word is, two', options: ['two', 'ten', 'try'], correct: 'two' },
    { word: 'The word is, more', options: ['more', 'make', 'most'], correct: 'more' },
    { word: 'The word is, write', options: ['write', 'white', 'with'], correct: 'write' },
    { word: 'The word is, go', options: ['go', 'no', 'do'], correct: 'go' },
    { word: 'The word is, see', options: ['see', 'saw', 'said'], correct: 'see' },
    { word: 'The word is, number', options: ['number', 'new', 'never'], correct: 'number' },
    { word: 'The word is, no', options: ['no', 'go', 'on'], correct: 'no' },
    { word: 'The word is, way', options: ['way', 'day', 'say'], correct: 'way' },
    { word: 'The word is, could', options: ['could', 'would', 'call'], correct: 'could' },
    { word: 'The word is, people', options: ['people', 'paper', 'pupil'], correct: 'people' },
    { word: 'The word is, my', options: ['my', 'me', 'by'], correct: 'my' },
    { word: 'The word is, than', options: ['than', 'that', 'ten'], correct: 'than' },
    { word: 'The word is, first', options: ['first', 'fast', 'find'], correct: 'first' },
    { word: 'The word is, water', options: ['water', 'wait', 'went'], correct: 'water' },
    ...
    { word: 'The word is, long', options: ['long', 'look', 'low'], correct: 'long' },
    { word: 'The word is, down', options: ['down', 'now', 'done'], correct: 'down' },
    { word: 'The word is, day', options: ['day', 'way', 'say'], correct: 'day' },
    { word: 'The word is, did', options: ['did', 'do', 'down'], correct: 'did' },
    { word: 'The word is, get', options: ['get', 'go', 'got'], correct: 'get' },
    { word: 'The word is, come', options: ['come', 'came', 'see'], correct: 'come' },
    { word: 'The word is, made', options: ['made', 'had', 'mad'], correct: 'made' },
    { word: 'The word is, may', options: ['may', 'my', 'many'], correct: 'may' },
    { word: 'The word is, part', options: ['part', 'past', 'pat'], correct: 'part' },
];
...
window.VIDEO_DATABASE = [
    { title: "Animal Fact Video 1: Fennec Foxes", url: "https://www.youtube.com/embed/5Juw9y46ruk?controls=0" }, 
    { title: "Animal Fact Video 2: Axolotl Regeneration", url: "https://www.youtube.com/embed/es5NamAO0qU?controls=0" }, 
    { title: "Animal Fact Video 3: Goblin Shark Jaws", url: "https://www.youtube.com/embed/fYpn2u2Wag4?controls=0" }, 
    { title: "Animal Fact Video 4: Pangolin Armor", url: "https://www.youtube.com/embed/5vfe_pTlGEQ?controls=0" }, 
    { title: "Animal Fact Video 5: Okapi's Long Tongue", url: "https://www.youtube.com/embed/4j5-4rjrbqM?controls=0" }, 
    { title: "Animal Fact Video 6: Komodo Dragon Venom", url: "https://www.youtube.com/embed/pFaSswGnT0I?controls=0" }, 
];
